...
/** 1648 reactions, packed as text so the whole catalog costs one
 *  string in the bundle and is parsed lazily on first use. */
export const TEAMS_EMOJI_CATALOG = `1f603_grinningfacewithbigeyes 😃
happyface 😃
...
vegetablegarden ♻️
electriccar ♻️
europeafricainhand ♻️ +
americainhand ♻️ +
asiaaustraliainhand ♻️ +
1f453_glasses 👓
1f576_sunglasses 🕶️
1f97d_goggles 🥽
1f97c_labcoat 🥼
