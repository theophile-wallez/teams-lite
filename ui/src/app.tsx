...
export function App() {
  ...
  useKeyboard((e) => {
    // While a dialog is open it owns every key. DialogSelect drives navigation,
    // selection and Escape-to-close, so global shortcuts must stay dormant.
    if (paletteOpen() || settingsOpen() || messageMenu()) return;
    if (e.ctrl && e.name === "k") {
      setPaletteOpen(true);
      return;
    }
